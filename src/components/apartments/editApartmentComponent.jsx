...
//Ny kod nedan utan adressvalidering
...
function EditApartmentComponent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateApartment(apartmentId, apartment);
      console.log("LägenhetID som uppdateras:", apartmentId, apartment);
      displaySuccessMessage(
        `Objektet med adress: ${apartment.apartmentLocation} har uppdaterats`
      );
      router.back("/dashboard/apartments");
    } catch (error) {
      displayErrorMessage("Lägenheten kunde inte uppdateras");
      // router.push("/dashboard/apartments");
    }
  };
